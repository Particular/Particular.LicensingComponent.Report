...
[TestFixture]
public class LicensingComponent_Report_Signature_Tests
{
    [Test]
    ...
    public void Should_be_able_to_read_a_V2_report()
    {
        ...
        Assert.That(data.EnvironmentInformation.EnvironmentData.ContainsKey("ServiceControlVersion"), Is.True);
        Assert.That(data.EnvironmentInformation.EnvironmentData["ServiceControlVersion"], Is.EqualTo("5.0.1"));
        Assert.That(data.EnvironmentInformation.EnvironmentData.ContainsKey("ServicePulseVersion"), Is.True);
        Assert.That(data.EnvironmentInformation.EnvironmentData["ServicePulseVersion"], Is.EqualTo("2.3.1"));
        Assert.That(data.EnvironmentInformation.EnvironmentData.ContainsKey("AuditEnabled"), Is.True);
    ...
    SignedReport CreateReport()
    {
        ...
        var reportData = new Report
        {
            ...
            EnvironmentInformation = new EnvironmentInformation { EnvironmentData = new Dictionary<string, string> { ["BrokerVersion"] = "1.2.0" } }
        };
